...
```
To clean up the mess from trying to install with the old debianutils:  
`sudo dpkg --remove --force-remove-reinstreq linux-image-unsigned-6.19.11-061911-generic`
